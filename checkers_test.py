...
class MyTestCase(unittest.TestCase):
    def test_white_won(self):
        brd = Board()
        brd.board[4][1] = Piece(4, 1, is_white=True, is_queen=False)
        self.assertTrue(brd.white_won())

    def test_can_move(self):
        brd = Board()
        brd.board[5][0] = Piece(5, 0, is_white=True, is_queen=False)
        brd.board[4][1] = Piece(4, 1, is_white=False, is_queen=False)
        brd.board[3][2] = Piece(3, 2, is_white=False, is_queen=False)
        brd.white_player = Player(is_white=True)
        brd.black_player = Player(is_white=False)
        brd.display()
        brd.count_pieces()
        print(str(brd.available_moves(brd.white_player, capturing = None)))
    ...
    def test_should_catpture(self):
        ...
        brd.board[5][0] = Piece(5, 0, is_white=True, is_queen=False)
        brd.board[4][1] = Piece(4, 1, is_white=False, is_queen=False)
        brd.board[3][4] = Piece(5, 2, is_white=False, is_queen=False)
        brd.board[6][4] = Piece(5, 0, is_white=True, is_queen=False)
    ...
    def test_is_draw(self):
        ...
        brd.white_player = Player(is_white=True)
        brd.black_player = Player(is_white=False)
        brd.board[5][0] = Piece(5, 0, is_white=True, is_queen=True)
        brd.board[3][0] = Piece(3, 0, is_white=False, is_queen=True)
        for i in range(15):
            if i % 2 == 0:
    ...
    def test_avaialble_moves(self):
        ...
        white = Player(is_white=True)
        brd.white_player = white
        brd.board[5][5] = Piece(5, 5, is_white=True, is_queen=False)
        correct_moves = [Point(4, 6), Point(4, 4)]
        self.assertEqual(set(correct_moves), set(brd.board[5][5].available_moves(white, brd.board) ))
